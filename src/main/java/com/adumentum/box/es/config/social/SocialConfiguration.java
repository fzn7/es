package com.adumentum.box.es.config.social;

import com.adumentum.box.es.repository.CustomSocialUsersConnectionRepository;
import com.adumentum.box.es.repository.SocialUserConnectionRepository;
import com.adumentum.box.es.security.jwt.TokenProvider;
import com.adumentum.box.es.security.social.CustomSignInAdapter;
...
public class SocialConfiguration implements SocialConfigurer {
	...
	public void addConnectionFactories(ConnectionFactoryConfigurer connectionFactoryConfigurer, Environment environment) {
		...
		String dropboxClientId = environment.getProperty("spring.social.dropbox.client-id");
		String dropboxClientSecret = environment.getProperty("spring.social.dropbox.client-secret");
		if (dropboxClientId != null && dropboxClientSecret != null) {
			log.debug("Configuring DropboxConnectionFactory");
			connectionFactoryConfigurer.addConnectionFactory(
				new DropboxConnectionFactory(
					dropboxClientId,
					dropboxClientSecret,
					Boolean.TRUE
				)
			...
			log.error("Cannot configure DropboxConnectionFactory id or secret null");
		}
